                    ...
                    <div class="col-md-5">
						<div class="product-details">
							...
							<div>
								...
								<a class="review-link" href="#review-form">10 Giới thiệu(s) | Thêm giới thiệu</a>
							</div>
							<div>
								<h3 class="product-price">'.$row['product_price'].'</h3><span> VND</span>
												...
												<ul class="reviews">
													...
													<li>
														<div class="review-heading">
															<h5 class="name">Phúc</h5>
															<p class="date">15/07/2021, 8:0 PM</p>
														...
														<div class="review-body">
															<p>Sản phẩm rất ưng tôi đánh giá 5 sao</p>
														</div>
													</li>
												</ul>
